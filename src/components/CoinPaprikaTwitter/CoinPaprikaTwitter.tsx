...
import styles from "./CoinPaprikaTwitter.module.css";
...
const CoinPaprikaTwitter = (props: Props): JSX.Element => {
  ...
  async function fetchData() {
    ...
    let btcResponse = await axios({
      method: "GET",
      url: "https://coinpaprika1.p.rapidapi.com/coins/btc-bitcoin/twitter",
      headers: {
    ...
    // eth-ethereum
    let ethResponse = await axios({
      method: "GET",
      url: "https://coinpaprika1.p.rapidapi.com/coins/eth-ethereum/twitter",
      headers: {
        "x-rapidapi-host": "coinpaprika1.p.rapidapi.com",
        "x-rapidapi-key": "9d6d64d48dmsh56a7cd3df5b315ap180b67jsn5f6aa34f0119",
      },
    ...
    // ada-cardano
    let adaResponse = await axios({
      method: "GET",
      url: "https://coinpaprika1.p.rapidapi.com/coins/ada-cardano/twitter",
      headers: {
        "x-rapidapi-host": "coinpaprika1.p.rapidapi.com",
        "x-rapidapi-key": "9d6d64d48dmsh56a7cd3df5b315ap180b67jsn5f6aa34f0119",
      },
    ...
    const btcData: any = await btcResponse.data;
    const ethData: any = await ethResponse.data;
    const adaData: any = await adaResponse.data;

    const unShuffledTweets: twitterData = btcData.concat(ethData, adaData);

    const tweets = shuffle(unShuffledTweets);
    const formatedData = tweets.map(
      (item) => `@${item.user_name} ~ ${item.status}`
    );
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "13% 87%" }}>
      <div style={{ fontWeight: 500, padding: "10%" }}>Twitter Feed</div>
...
export default CoinPaprikaTwitter;
